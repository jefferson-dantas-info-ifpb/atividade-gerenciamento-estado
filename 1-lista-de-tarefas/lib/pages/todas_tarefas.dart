...
import 'package:listadetarefas/widgets/resumo.dart';
import 'package:listadetarefas/widgets/tarefa_item.dart';
import 'package:provider/provider.dart';

class TodasTarefas extends StatelessWidget {
  const TodasTarefas({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const MyAppBar(title: 'Todas as Tarefas'),
      drawer: const MyDrawer(paginaAtual: 'todas-tarefas'),
      body: Column(
        children: [
          const Resumo(),
          Expanded(
